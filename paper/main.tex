...
while LiDAR and radar contribute negligibly---a result that cross-modal KD
exploits directly.
...
compact cross-attention core with 21.7~M parameters---a 3.6$\times$ reduction
over the baseline---while matching baseline DBA at $1.66\times$ lower latency
