...
def main():
    ...
    if rank == 0:
        ...
        for path in ['log/s32_v5b/best_model.pth',
                     'log/s32_v5b_s2b/best_model.pth',
                     'log/s32_v5b_s3b/best_model.pth',
    ...
    student.load_state_dict(torch.load('log/s32_v11_camgps/best_model.pth',
    ...
    for epoch in range(args.epochs):
        ...
        for data in pbar:
            ...
            zero_lidars = [torch.zeros_like(l) for l in lidars]
            zero_radars = [torch.zeros_like(r) for r in radars]
            student_logits = ms.predict(fronts, zero_lidars, zero_radars, gps)
